...
export const getLatestProducts = TryCatch(async (req, res, next) => {
    ...
    if (mynodecache.has("latestproducts")) {
        products = JSON.parse(mynodecache.get("latestproducts"));
    }
...
export const getAdminProducts = TryCatch(async (req, res, next) => {
    ...
    if (mynodecache.has("products")) {
        adminproducts = JSON.parse(mynodecache.get("adminproducts"));
    }
    else {
...
export const getSingleProduct = TryCatch(async (req, res, next) => {
    ...
    if (mynodecache.has(`product-${req.params.id}`)) {
        product = JSON.parse(mynodecache.get(`product-${req.params.id}`));
    }
    else {
